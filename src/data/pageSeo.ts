...
export const defaultPageSeo: PageSeoConfig = {
  ...
  description:
    "Observeri is an AI-powered cybersecurity GRC platform unifying governance, risk, compliance, and continuous threat exposure management for modern enterprises.",
  keywords:
...
export const pageSeoByPath: Record<string, PageSeoConfig> = {
  ...
  "/about": {
    ...
    description:
      "Learn how Observeri Technologies builds AI-powered cybersecurity GRC software that unifies risk, compliance, and security operations for regulated enterprises.",
  ...
  "/career": {
    ...
    description:
      "Explore open roles at Observeri Technologies and help build the next generation of AI-driven governance, risk, and compliance software for enterprises.",
  ...
  "/newsroom": {
    ...
    description:
      "Latest news, announcements, and media coverage from Observeri Technologies on cybersecurity GRC, AI risk management, and enterprise compliance programs.",
  ...
  "/features": {
    ...
    description:
      "Explore Observeri GRC modules: AI Risk Operations Center, attack surface management, vulnerability operations, compliance, and executive risk dashboards.",
    keywords:
  ...
  "/products/third-party-risk": {
    ...
    description:
      "Observeri TPRM automates vendor discovery, AI risk prioritization, evidence collection, and gap remediation with audit-ready third party risk dossiers.",
    keywords:
  ...
  "/products/cyber-risk-management": {
    ...
    description:
      "Observeri cyber risk management software links risks to live controls and assets, auto-updates scores, and adds AI prioritization and FAIR quantification.",
    keywords:
  ...
  "/products/vulnerability-operations": {
    ...
    description:
      "Observeri Vulnerability Operations ingests CVEs, prioritizes with EPSS and threat feeds, tracks SLAs, and drives AI-guided remediation programmes at scale.",
    keywords:
  ...
  "/products/ai-risk-operations-center": {
    ...
    description:
      "Observeri AI Risk Operations Center fuses incidents, risks, vulnerabilities, threats, and compliance into live asset risk scores for focused remediation.",
    keywords:
  ...
  "/products/security-governance": {
    ...
    description:
      "Observeri Security Governance delivers KRI/KPI monitoring, AI policy management, risk-informed budgeting, and change management for CISOs and boards.",
    keywords:
  ...
  "/products/exposure-management": {
    ...
    description:
      "Observeri Exposure Management unifies attack surface management, threat monitoring, dark web monitoring, issue tracking, and AI-prioritized remediation.",
    keywords:
  ...
  "/products/external-attack-surface-management": {
    ...
    description:
      "Observeri EASM continuously discovers domains, hosts, and shadow IT, then maps attack paths, dark web exposure, and cloud risks into GRC remediation.",
    keywords:
  ...
  "/products/compliance-management": {
    ...
    description:
      "Observeri Compliance Management maintains regulations, builds AI compliance registers, runs horizon-scanning self-assessments, and tracks submissions.",
    keywords:
  ...
  "/products/information-asset-management": {
    ...
    description:
      "Observeri Information Asset Management ingests assets, applies live AI risk scores and control effectiveness, and maps a unified estate exposure view.",
    keywords:
  ...
  "/products/human-risk-management": {
    ...
    description:
      "Observeri Human Risk Management scans privileged identities, calculates HRE scores, and quantifies financial exposure with automated access controls.",
    keywords:
  ...
  "/products/data-privacy-protection": {
    ...
    description:
      "Observeri Data Privacy & Protection detects PII, discovers sensitive data and secrets, and scores data exposure with NER-based classification everywhere.",
    keywords:
  ...
  "/consultancy-service": {
    ...
    description:
      "Observeri consultancy: security architecture, incident response readiness, GRC integration, red teaming, forensics, and cyber maturity assessments.",
  ...
  "/partners": {
    ...
    description:
      "Join the Observeri partner ecosystem—resellers, auditors, and technology partners delivering AI-powered GRC to enterprises across global markets.",
  ...
  "/solutions/banking-financial-services": {
    ...
    description:
      "Observeri delivers AI-powered GRC for banks and fintechs—automating CBUAE, DFSA, AML/CFT, SOX, and PCI DSS obligations, controls, and risk remediation.",
  ...
  "/solutions/healthcare-life-sciences": {
    ...
    description:
      "Observeri healthcare GRC secures IoMT ecosystems, protects PHI, and automates HIPAA and privacy compliance with AI risk assessments and audit readiness.",
  ...
  "/solutions/government-public-sector": {
    ...
    description:
      "Observeri public-sector GRC unifies governance, sovereign data protection, and automated NESA assurance with continuous, audit-ready risk workflows.",
  ...
  "/solutions/technology-saas": {
    ...
    description:
      "Observeri GRC helps SaaS and technology teams ship fast while automating SOC 2, vendor risk, API visibility, and secure-engineering controls at scale.",
  ...
  "/solutions/retail-ecommerce": {
    ...
    description:
      "Observeri retail GRC protects transaction-heavy environments and customer data, automating PCI DSS compliance, vendor risk, and fraud reduction at scale.",
  ...
  "/solutions/energy-utilities": {
    ...
    description:
      "Observeri GRC secures critical infrastructure with OT-aware risk intelligence and compliance automation for NERC readiness and operational continuity.",
