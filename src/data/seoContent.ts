/**
 * Semantic copy clusters for homepage / LLM-visible positioning (Google, ChatGPT, Claude, Gemini).
 * Keep sentences readable—avoid naked keyword lists.
 */
export const enterpriseGrcTopicSections = [
  {
    id: "core-platform",
    title: "Cybersecurity GRC platform for the full risk and compliance system",
    body:
  ...
  {
    id: "ai-grc",
    title: "AI GRC platform with predictive cyber risk analytics",
    body:
  ...
  {
    id: "quantification",
    title: "FAIR-aligned cyber risk financial modeling and ROI",
    body:
  ...
  {
    id: "buyer-intent",
    title: "Best GRC software for enterprises, UAE / Middle East, banks, and fintech",
    body:
  ...
  {
    id: "alternatives",
    title: "Alternatives to MetricStream, ServiceNow GRC, Archer, LogicGate, OneTrust",
    body:
  ...
  {
    id: "how-to-topics",
    title: "Problem-led discovery: prioritize risk, implement GRC, automate compliance",
    body:
  ...
  {
    id: "features",
    title: "Feature-led journeys: registers, controls, audits, vendors, BC",
    body:
...
export const industrySeoContext: Record<string, string> = {
  "banking-financial-services":
    "Observeri supports GRC software for banks, fintech compliance platform rollouts, risk management for financial institutions, and Islamic finance compliance system controls with AI-assisted evidence and obligation mapping.",
  "healthcare-life-sciences":
    "Healthcare organizations use Observeri as healthcare compliance software and a HIPAA risk management platform that connects clinical operations, privacy, and security risk in one program.",
  "government-public-sector":
    "Public sector teams adopt Observeri as a public sector GRC platform and government risk management system for continuous assurance, accountability, and audit-ready workflows.",
  "technology-saas":
  ...
  "retail-ecommerce":
    "Retail and e-commerce security leaders align PCI DSS compliance solution requirements with operational risk using audit workflow automation and vendor risk assessment workflows.",
  "energy-utilities":
    "Energy and industrial operators rely on Observeri for industrial cybersecurity GRC and risk management for oil and gas environments that blend OT visibility with enterprise governance.",
};
